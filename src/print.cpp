...
void printThisTab(QWidget* tab){
    auto * const te = getTextEdit(tab);
    if( te == nullptr ) return;  // BUG: Le layout n'est pas bon :-(
...
void printThisTab2pdf(QWidget* tab, const QString& fileName){
    auto * const te = getTextEdit(tab);
    if( te == nullptr ) return;  // BUG: Le layout n'est pas bon :-(
...
void MainWindow::on_pushButton_Data_clicked(){
    if(canPrint) printThisTab(ui->tab_Data);
}

void MainWindow::on_pushButton_Proportionnelle_clicked(){
    if(canPrint) printThisTab(ui->tab_Proportionnelle);
}

void MainWindow::on_pushButton_Moyenne_clicked(){
    if(canPrint) printThisTab(ui->tab_Moyenne);
}

void MainWindow::on_pushButton_Bonus_clicked(){
    if(canPrint) printThisTab(ui->tab_Bonus);
}

void MainWindow::on_pushButton_Limitation_clicked(){
    if(canPrint) printThisTab(ui->tab_Limitation);
}

void MainWindow::on_pushButton_Options_clicked(){
    if(canPrint) printThisTab(ui->tab_Options);
}

void MainWindow::on_pushButton_Summary_clicked(){
    if(canPrint) printThisTab(ui->tab_Summary);
}
...
void MainWindow::on_pushButton_DataPdf_clicked(){
    if(canPrint) printThisTab2pdf(ui->tab_Data, "Données");
}

void MainWindow::on_pushButton_ProportionnellePdf_clicked(){
    if(canPrint) printThisTab2pdf(ui->tab_Proportionnelle, "Proportionnelle-Simple");
}

void MainWindow::on_pushButton_MoyennePdf_clicked(){
    if(canPrint) printThisTab2pdf(ui->tab_Moyenne, "Plus-Forte-Moyenne");
}

void MainWindow::on_pushButton_BonusPdf_clicked(){
    if(canPrint) printThisTab2pdf(ui->tab_Bonus, "Sièges-d'Office");
}

void MainWindow::on_pushButton_LimitationPdf_clicked(){
    if(canPrint) printThisTab2pdf(ui->tab_Limitation, "Limitation");
}

void MainWindow::on_pushButton_OptionsPdf_clicked(){
    if(canPrint) printThisTab2pdf(ui->tab_Options, "Sièges-Optionnels");
}

void MainWindow::on_pushButton_SummaryPdf_clicked(){
    if(canPrint) printThisTab2pdf(ui->tab_Summary, "Résumé");
}
